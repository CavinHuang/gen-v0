import { AgentRuntimeErrorType, IGenv0AgentRuntimeErrorType } from '@/lib/agent-runtime/error';

import { ChatErrorType, ErrorResponse, ErrorType } from '@/types/fetch';

const getStatus = (errorType: IGenv0AgentRuntimeErrorType | ErrorType) => {
...
export const createErrorResponse = (
  errorType: ErrorType | IGenv0AgentRuntimeErrorType,
  body?: any,
) => {
